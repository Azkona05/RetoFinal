...
public class Principal {
     ...
     * @throws LoginException Si las credenciales son incorrectas o ocurre un error durante el login.
     */
     ...
     * @throws LoginException Si ocurre un error durante la búsqueda de competiciones.
     */
     ...
     * @throws LoginException Si ocurre un error durante la obtención de competiciones.
     */
     ...
     * @throws LoginException Si ocurre un error durante la modificación del jugador.
     */
     ...
     * @throws LoginException Si ocurre un error durante la modificación de la competición.
     */
     ...
     * @throws LoginException Si ocurre un error durante la eliminación de la competición.
     */
     ...
     * @throws LoginException Si ocurre un error durante la obtención de las competiciones.
     */
